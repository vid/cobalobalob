  ...
  // const task = `A web service that provides actual live otters (not video or pictures but real touchable furry otters) with real turbulence the user participates in, on a dashboard.`;
